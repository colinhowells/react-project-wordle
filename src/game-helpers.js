/**
 * Check the guess against the answer and return an array of objects
 ...
 * @returns {?Array<{letter: string, status: 'incorrect'|'correct'|'misplaced'}>} An array of objects representing the status of each letter in the guess
 * @example
 * [
